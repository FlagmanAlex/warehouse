...
const orderDetailsSchema = new mongoose_1.Schema({
    orderId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Order', required: true }, // Ссылка на заказ
...
exports.OrderDetailsModel = mongoose_1.default.model('OrderDetail', orderDetailsSchema, 'OrderDetail');
